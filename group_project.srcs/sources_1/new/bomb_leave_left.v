...
always @(posedge clk_6p25m) begin
    ...
    begin
        ...
        if (circle_x > 0) //control where circle stops
        begin
    ...
    if (rectangle_move_counter >= bomb_speed) begin
        ...
        if (rect_x > 0) //control where rectangle stops . increase to stop more right. decrease to stop more left
        begin
            rect_x <= rect_x - 1;
        end
    end
    ...
    begin
        ...
        if (fuse_1_x > 0) //end point of the fuse
        begin 
    ...
    begin
        ...
        if (fuse_2_x > 0) //end point of the fuse
        begin 
    ...
    begin
        fire_move_counter <= 0;
        if (fire_x > fuse_1_length) //control where circle stops
        begin
