...
//            if (game_state == 1) //no bomb
//            begin
//                oled_data <= 16'h FFFF;
//            end
            
            if (game_state == 1) 
            oled_data <= bomb_at_center_wire;
            
            if(game_state == 3 && counter < 60000000) //BOMB EXPLODE
            begin
...
//            end
            ...
            if (game_state == 2) //game_end and bomb not exploded
            begin
                oled_data <= you_win_wire;
            end
            
            if (game_state == 3 && counter >= 60000000) // game end and bomb exploded
            begin
           ...
           if (game_state == 1) begin 
            ...
            if (ticking == 1) // quater 0
            begin
                bomb_animation_rate = 1171875;
            end
            else if (ticking == 2) //q1
            begin
                bomb_animation_rate <= 937500;
            end
            else if (ticking == 3) //q2
            begin
                bomb_animation_rate <= 703125;
            end
            else if (ticking == 4) //q3
            begin
